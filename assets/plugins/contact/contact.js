...
var contact = (function() {
    ...
    var formTracker = $('#fitness_tracker');
        ...
        $.ajax({
            ...
            success: function( json, textStatus ) {
                ...
                if( json.error ) {
                    ...
                    if( json.error.fitness_tracker ) {
                        formTracker.parent().addClass('has-error');
                        formTracker.next('.help-block').html( json.error.fitness_tracker ).slideDown();
                    }
                }
